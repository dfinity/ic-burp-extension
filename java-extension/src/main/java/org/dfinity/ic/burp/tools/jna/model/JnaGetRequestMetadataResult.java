...
@Structure.FieldOrder({"error_message", "request_type", "sender", "pubkey", "sig", "delegation", "request_id", "canister_id", "canister_method"})
public class JnaGetRequestMetadataResult extends Structure {
    ...
    public RequestMetadata toRequestMetadata() throws IcToolsException {
        ...
        return Request.metadata(RequestType.from(request_type), JnaRequestSenderInfo.toRequestSenderInfo(sender, pubkey, sig, delegation), rid, cid, method);
    }
